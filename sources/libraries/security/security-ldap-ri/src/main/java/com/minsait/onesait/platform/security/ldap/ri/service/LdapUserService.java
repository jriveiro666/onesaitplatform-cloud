...
public class LdapUserService {
	...
	public List<User> getAllUsers(String dn) throws InvalidNameException {
	...
	public List<User> getAllUsersFromGroup(String dn, String cn) throws InvalidNameException {
