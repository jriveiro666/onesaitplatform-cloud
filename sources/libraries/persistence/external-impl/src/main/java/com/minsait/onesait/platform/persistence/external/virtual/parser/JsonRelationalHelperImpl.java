...
public class JsonRelationalHelperImpl implements JsonRelationalHelper {
	...
	// private static final String ORACLE_TIMESTAMP_FORMAT = "dd-MMM-yy HH.mm.ss";
	//
	//
	// private SimpleDateFormat sdfIso8601 = new
	// SimpleDateFormat("yyy-MM-dd'T'HH:mm:ss'Z'");
	//
	// private SimpleDateFormat sdfOracle;
	//
	// @PostConstruct
	// public void init() {
	// try {
	// this.sdfOracle = new SimpleDateFormat(
	// ArqSpringContext.getPropiedad(Properties.DB_BDTR_RELATIONAL_TIMESTAMP_FORMAT));
	// } catch (PropiedadNoEncontradaExcepcion e) {
	// log.warn("No se ha encontrado la propiedad: " +
	// Properties.DB_BDTR_RELATIONAL_TIMESTAMP_FORMAT
	// + ". Se utiliza valor por defecto: " + ORACLE_TIMESTAMP_FORMAT);
	// this.sdfOracle = new SimpleDateFormat(ORACLE_TIMESTAMP_FORMAT);
	// }
	// }
	//
	// @Override
	...
	//
	// if (!nativeQuery.contains("db.")) {
	// throw new PersistenceException(new Exception("No found collectionin query"));
	// }
	// String qType = "";
	// if (nativeQuery.toLowerCase().contains(".find")) {
	// qType = ".find";
	// } else if (nativeQuery.toLowerCase().contains(".update")) {
	// qType = ".update";
	// } else if (nativeQuery.toLowerCase().contains(".remove")) {
	// qType = ".remove";
	// }
