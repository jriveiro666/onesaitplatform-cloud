...
public class OracleVirtualOntologyHelper implements VirtualOntologyHelper {
	...
	private final static String LIST_TABLES_QUERY = "SELECT table_name FROM user_tables";
	private final static String ROWNUM_STR = "ROWNUM";
				...
				ExpressionDeParser expressionDeparser = new ExpressionDeParser() {
					...
					private void validateRowNum(Expression expr) {
						if (expr instanceof MinorThan || expr instanceof EqualsTo) {
							if (((ComparisonOperator) expr).getLeftExpression().toString().equals(ROWNUM_STR)) {
