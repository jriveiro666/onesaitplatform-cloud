...
@Component("HiveVirtualOntologyHelper")
@Slf4j
public class HiveVirtualOntologyHelper implements VirtualOntologyHelper {
			...
			if(statement instanceof Select) {
				...
				if ( !hasLimit ) {
					...
					if(select.getOffset() == null) {
						...
						offsetObj.setOffset(new Long( (offset >= 0 ? offset : 0) ));
