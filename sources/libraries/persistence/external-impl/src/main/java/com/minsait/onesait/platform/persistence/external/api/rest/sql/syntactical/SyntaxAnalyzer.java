...
public class SyntaxAnalyzer {
	...
	@Autowired
	private SelectSyntaxAnalyzer selectAnalyzer = new SelectSyntaxAnalyzer();
	@Autowired
	private InsertSyntaxAnalyzer insertAnalyzer = new InsertSyntaxAnalyzer();
	@Autowired
	private DeleteSyntaxAnalyzer deleteAnalyzer = new DeleteSyntaxAnalyzer();
	@Autowired
	...
	public QueryAnalysisResult runSyntaxAnalysis(List<Token> tokens, List<String> requestedPathParams,
		...
		QueryAnalysisResult parserResult = new QueryAnalysisResult(requestedPathParams, requestedQueryParams);
