...
@Component("ImpalaQueryAsTextDBRepository")
@Scope("prototype")
@Lazy
@Slf4j
...
public class ImpalaQueryAsTextDBRepository implements QueryAsTextDBRepository {
	...
	@Autowired
	private HadoopQueryProcessor hiveProcessor;

	@Override
	public String queryNativeAsJson(String ontology, String query, int offset, int limit)
			throws DBPersistenceException {
		return jdbcTemplate.query(hiveProcessor.parse(query), new DefaultResultSetExtractor());
	}
