...
public interface QuasarMongoDBbHttpConnector {
	...
	String queryAsJson(String collection, String query, int offset, int limit) throws DBPersistenceException;

	String queryAsTable(String query, int offset, int limit) throws DBPersistenceException;

	String compileQueryAsJson(String collection, String query, int offset);
}
