...
public class QuasarMongoDBbHttpImpl implements QuasarMongoDBbHttpConnector {
	...
	public String queryAsTable(String query, int offset, int limit) throws DBPersistenceException {
		...
		final String result = quasarHttpClient.invokeSQLPlugin(url, BaseHttpClient.ACCEPT_TEXT_CSV, null);
		return result;
	...
	private String handleCompileQuery(String url, String query, String collection) throws DBPersistenceException {
		try {
