...
public class User extends AuditableEntity {
	...
	public String getPassword() {
		if (this.password != null && this.password.startsWith(JPAHAS256ConverterCustom.storedFlag)) {
			return this.password.substring(JPAHAS256ConverterCustom.storedFlag.length());
		} else {
