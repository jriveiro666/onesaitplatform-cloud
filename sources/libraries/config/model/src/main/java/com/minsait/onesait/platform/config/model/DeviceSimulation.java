...
public class DeviceSimulation extends AuditableEntityWithUUID {
	...
	public static enum Type {
		FIXED_INTEGER, FIXED_NUMBER, FIXED_STRING, FIXED_DATE, RANDOM_INTEGER, RANDOM_NUMBER, RANDOM_STRING, RANDOM_DATE, COSINE_NUMBER, SINE_NUMBER, FIXED_BOOLEAN, RANDOM_BOOLEAN, NULL
	}
