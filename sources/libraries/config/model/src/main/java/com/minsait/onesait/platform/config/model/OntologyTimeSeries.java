...
public class OntologyTimeSeries extends AuditableEntityWithUUID {
	...
	@Getter
	@Setter
	private Set<OntologyTimeSeriesWindow> timeSeriesWindows = new HashSet<OntologyTimeSeriesWindow>();

	@OneToMany(mappedBy = "ontologyTimeSeries", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.EAGER)
	@OnDelete(action = OnDeleteAction.CASCADE)
	@Getter
	@Setter
	private Set<OntologyTimeSeriesProperty> timeSeriesProperties = new HashSet<OntologyTimeSeriesProperty>();
