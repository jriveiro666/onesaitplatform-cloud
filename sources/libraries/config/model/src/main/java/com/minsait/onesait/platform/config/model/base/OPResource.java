...
public abstract class OPResource extends AuditableEntity {
	...
	public enum Resources {
		API, CLIENTPLATFORM, DIGITALTWINDEVICE, DASHBOARD, FLOWDOMAIN, GADGET, NOTEBOOK, ONTOLOGY, DATAFLOW, GADGETDATASOURCE
	}
	...
	// @OneToMany(mappedBy = "resource", cascade = CascadeType.REMOVE, orphanRemoval
	// = true, fetch = FetchType.LAZY)
	// @SortComparator(ProjectResourceAccessComparator.class)
	// @Getter
	// @Setter
	// private SortedSet<ProjectResourceAccess> projectResourceAccesses = new
	// TreeSet<>(
	// new ProjectResourceAccessComparator());
