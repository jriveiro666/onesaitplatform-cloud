...
public class MicroserviceRepositoryTest {
	...
	public void setUp() {
		jenkinsConfiguration = JenkinsConfiguration.builder()
				...
				.token("cb58d41fc7196684e2510b7bce6b9198").build();
		gitlabConfiguration = GitlabConfiguration.builder().privateToken("xmZy_Pdy118HXzy7wrvh")
				.site("https://onesait-git.cwbyminsait.com/").build();
		rancherConfiguration = RancherConfiguration.builder()
				.url("http://sofia2-dockerstack.westeurope.cloudapp.azure.com").accessKey("471D90A16431C2CE7158")
				.secretKey("VSoq31eGBqaFsG4vUcuvdpkQL1T64FypVPVckaDx").build();
	}
