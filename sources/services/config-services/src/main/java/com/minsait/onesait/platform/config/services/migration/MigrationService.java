...
public interface MigrationService {
	...
	public ExportResult exportData(MigrationConfiguration config) throws IllegalArgumentException, IllegalAccessException;
	...
	public LoadEntityResult loadData(MigrationConfiguration config, DataFromDB readData) throws ClassNotFoundException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, InstantiationException;

	public void persistData(List<Object> entities, MigrationErrors errors) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException;
	...
	public MigrationErrors importAll(DataFromDB data) throws ClassNotFoundException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, InstantiationException;
	...
	public String compareSchemas(String currentSchemaJson, String otherSchemaJson) throws JsonParseException, JsonMappingException, IOException;
