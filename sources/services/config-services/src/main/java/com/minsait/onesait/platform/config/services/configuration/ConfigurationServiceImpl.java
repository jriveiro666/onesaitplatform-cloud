...
public class ConfigurationServiceImpl implements ConfigurationService {
	...
	public TwitterConfiguration getTwitterConfiguration(String environment, String suffix) {
		try {
			...
			return getAllConfigurationFromDBConfig(config).getTwitter();
	...
	@Override
	public String getDefaultJenkinsXML() {
		final Configuration configuration = this.getConfiguration(Type.JENKINS, "default", "pipeline");
		if (configuration == null)
			return new String();
