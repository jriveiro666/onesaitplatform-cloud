...
public class MigrationError {
	...
	@Getter final private ErrorType type;
	@Getter final private String msg;
	@Getter final private Instance neededInstance;
	@Getter final private Instance processedInstance;
	
	final public Instance NOINSTANCE = new Instance(null,null);
    ...
    public boolean equals(Object o) {
        ...
        return getNeededInstance() != null &&
        		getNeededInstance().equals(that.getNeededInstance()) &&
        		getProcessedInstance() != null  &&
        				getProcessedInstance().equals(that.getProcessedInstance());
    }
