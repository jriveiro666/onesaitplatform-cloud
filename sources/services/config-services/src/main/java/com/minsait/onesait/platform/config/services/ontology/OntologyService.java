...
public interface OntologyService {
	...
	// List<String> getTablesFromDatasource(String datasource);

	// String getInstance(String datasource, String collection);

	OntologyVirtual getOntologyVirtualByOntologyId(Ontology ontology);

	String getRtdbFromOntology(String ontologyIdentification);

	void checkOntologySchema(String schema) throws OntologyDataJsonProblemException;
