...
public class InitConfigDB {
	...
	public void init() {
		if (!started) {
			...
			init_ConsoleMenu_RollBack();
			log.info("OK init_ConsoleMenu_RollBack");
			init_Configuration();
			...
			init_dataflow_user_access_type();
	...
	private void init_Configuration() {
		...
		if (config == null) {
			config = new Configuration();
			config.setDescription("microservice");
			config.setEnvironment("default");
			config.setId("MASTER-Configuration-16");
			config.setType(Type.DOCKER);
			config.setUser(getUserAdministrator());
			config.setSuffix("microservice");
			config.setYmlConfig(loadFromResources("configurations/Microservice-compose.yml"));
			configurationRepository.save(config);
		}
		config = configurationRepository.findByTypeAndEnvironmentAndSuffix(Type.JENKINS, "default", "pipeline");
		if (config == null) {
			config = new Configuration();
			...
			config.setType(Type.JENKINS);
			config.setUser(getUserAdministrator());
			config.setSuffix("pipeline");
			config.setYmlConfig(loadFromResources("configurations/JenkinsXMLTemplate.xml"));
			configurationRepository.save(config);
		}
	...
	public void init_ConsoleMenu_RollBack() {
		log.info("init ConsoleMenu_RollBack");
		try {
	...
	public void init_Gadget_QA_WindTurbines() {
		...
		if (gadgetRepository.findByIdentification("producer_errorCat") == null) {
			gadget = new Gadget();
		...
		if (gadgetRepository.findByIdentification("trend_errorCat") == null) {
			gadget = new Gadget();
		...
		if (gadgetRepository.findByIdentification("errorsBySite") == null) {
			gadget = new Gadget();
		...
		if (gadgetRepository.findByIdentification("producer_errorType") == null) {
			gadget = new Gadget();
		...
		if (gadgetRepository.findByIdentification("trend_errorType") == null) {
			gadget = new Gadget();
	...
	public void init_GadgetDatasource() {
		...
		if (gadgetDatasource.isEmpty()) {
			...
			gadgetDatasources.setOntology(ontologyRepository.findByIdentification("Restaurants"));
	...
	public void init_GadgetDatasource_OpenFlight() {
		...
		if (gadgetDatasourceRepository.findById("MASTER-GadgetDatasource-2") == null) {
			...
			gadgetDatasources.setDbtype("RTDB");
			gadgetDatasources.setRefresh(0);
			gadgetDatasources.setOntology(ontologyRepository.findByIdentification("routes"));
		...
		if (gadgetDatasourceRepository.findById("MASTER-GadgetDatasource-4") == null) {
			...
			gadgetDatasources.setDbtype("RTDB");
			gadgetDatasources.setRefresh(0);
			gadgetDatasources.setOntology(ontologyRepository.findByIdentification("routesexten"));
		...
		if (gadgetDatasourceRepository.findById("MASTER-GadgetDatasource-6") == null) {
			...
			gadgetDatasources.setDbtype("RTDB");
			gadgetDatasources.setRefresh(0);
			gadgetDatasources.setOntology(ontologyRepository.findByIdentification("airportsdata"));
			gadgetDatasources.setMaxvalues(10);
			gadgetDatasources.setConfig("[]");
			gadgetDatasources.setUser(getUserAnalytics());
			gadgetDatasourceRepository.save(gadgetDatasources);
	...
	public void init_GadgetDatasource_QA_WindTurbines() {
		...
		if (gadgetDatasourceRepository.findByIdentification("QA_overview") == null) {
			...
			gadgetDatasources.setDbtype("RTDB");
			gadgetDatasources.setRefresh(0);
			gadgetDatasources.setOntology(ontologyRepository.findByIdentification("QA_OVERVIEW"));
		...
		if (gadgetDatasourceRepository.findByIdentification("producer_errorCat") == null) {
			gadgetDatasources = new GadgetDatasource();
			...
			gadgetDatasources.setDbtype("RTDB");
			gadgetDatasources.setRefresh(0);
			gadgetDatasources.setOntology(ontologyRepository.findByIdentification("Producer_ErrorCat"));
			gadgetDatasources.setMaxvalues(100);
			gadgetDatasources.setConfig(
					"[['mainField_cat1','secondaryField_cat1'],['mainField_cat2,'secondaryField_cat2','tertiaryField_cat2']]");
			gadgetDatasources.setUser(getUserAnalytics());
		...
		if (gadgetDatasourceRepository.findByIdentification("trend_errorCat") == null) {
			gadgetDatasources = new GadgetDatasource();
			...
			gadgetDatasources.setDbtype("RTDB");
			gadgetDatasources.setRefresh(0);
			gadgetDatasources.setOntology(ontologyRepository.findByIdentification("errorsOnDate"));
			gadgetDatasources.setMaxvalues(100);
			gadgetDatasources.setConfig(
					"[['mainField_cat1','secondaryField_cat1'],['mainField_cat2,'secondaryField_cat2','tertiaryField_cat2']]");
			gadgetDatasources.setUser(getUserAnalytics());
		...
		if (gadgetDatasourceRepository.findByIdentification("errorsBySite") == null) {
			gadgetDatasources = new GadgetDatasource();
			...
			gadgetDatasources.setDbtype("RTDB");
			gadgetDatasources.setRefresh(0);
			gadgetDatasources.setOntology(ontologyRepository.findByIdentification("QA_DETAIL"));
			gadgetDatasources.setMaxvalues(100);
			gadgetDatasources.setConfig(
					"[['mainField_cat1','secondaryField_cat1'],['mainField_cat2,'secondaryField_cat2','tertiaryField_cat2']]");
			gadgetDatasources.setUser(getUserAnalytics());
		...
		if (gadgetDatasourceRepository.findByIdentification("producer_errorType") == null) {
			gadgetDatasources = new GadgetDatasource();
		...
		if (gadgetDatasourceRepository.findByIdentification("trend_errorType") == null) {
			gadgetDatasources = new GadgetDatasource();
			...
			gadgetDatasources.setDbtype("RTDB");
			gadgetDatasources.setRefresh(0);
			gadgetDatasources.setOntology(ontologyRepository.findByIdentification("errorsTypeOnDate"));
			gadgetDatasources.setMaxvalues(100);
			gadgetDatasources.setConfig(
					"[['mainField_cat1','secondaryField_cat1'],['mainField_cat2,'secondaryField_cat2','tertiaryField_cat2']]");
			gadgetDatasources.setUser(getUserAnalytics());
		...
		if (gadgetDatasourceRepository.findByIdentification("listerroraxpo") == null) {
			...
			gadgetDatasources.setDbtype("RTDB");
			gadgetDatasources.setRefresh(0);
			gadgetDatasources.setOntology(ontologyRepository.findByIdentification("QA_DETAIL_EXTENDED"));
	...
	private void init_Layers() {
		...
		if (layerRepository.findByIdentification("Inundaciones500").isEmpty()) {

			layer = new Layer();
			layer.setId("MASTER-Layer-02");
			layer.setIdentification("Inundaciones500");
	...
	private void init_Viewers() {
		...
		if (viewerRepository.findById("MASTER-Viewer-01") == null) {
			...
			final Layer layer02 = layerRepository.findByIdentification("Inundaciones500").get(0);
	...
	public void init_User() {
		...
		if (types.isEmpty()) {
			try {
				...
				type.setPassword("SHA256(z2kB6aNm2d95nEcUU6qKZi1AJTgPiZJrvRY2uZcMWxA=)");
	...
	public void init_MarketPlace() {
		...
		if (marketAssets.isEmpty()) {
			...
			createMarketAsset("MASTER-MarketAsset-13", "Notebook", MarketAsset.MarketAssetState.APPROVED,
					MarketAsset.MarketAssetType.DOCUMENT, MarketAsset.MarketAssetPaymentMode.FREE, true,
					"market/details/Notebookregression.json", "market/img/NOTEBOOK.png", "png",
			...
			createMarketAsset("MASTER-MarketAsset-14", "NotebookPython", MarketAsset.MarketAssetState.APPROVED,
					MarketAsset.MarketAssetType.DOCUMENT, MarketAsset.MarketAssetPaymentMode.FREE, true,
					"market/details/NotebookPythonClient.json", "market/img/NOTEBOOK.png", "png",
			...
			createMarketAsset("MASTER-MarketAsset-15", "NotebookSpark", MarketAsset.MarketAssetState.APPROVED,
					MarketAsset.MarketAssetType.DOCUMENT, MarketAsset.MarketAssetPaymentMode.FREE, true,
					"market/details/NotebookSparkClient.json", "market/img/NOTEBOOK.png", "png",
			...
			createMarketAsset("MASTER-MarketAsset-16", "NotebookZeppelin", MarketAsset.MarketAssetState.APPROVED,
					MarketAsset.MarketAssetType.DOCUMENT, MarketAsset.MarketAssetPaymentMode.FREE, true,
					"market/details/NotebookZeppelinInterpretes.json", "market/img/NOTEBOOK.png", "png",
			...
			createMarketAsset("MASTER-MarketAsset-17", "NoderedACSLanguage", MarketAsset.MarketAssetState.APPROVED,
					MarketAsset.MarketAssetType.DOCUMENT, MarketAsset.MarketAssetPaymentMode.FREE, true,
					"market/details/NoderedAzureCognitiveServiceLanguage.json", "market/img/NODERED.png", "png",
			...
			createMarketAsset("MASTER-MarketAsset-18", "NoderedACSSpeech", MarketAsset.MarketAssetState.APPROVED,
					MarketAsset.MarketAssetType.DOCUMENT, MarketAsset.MarketAssetPaymentMode.FREE, true,
					"market/details/NoderedAzureCognitiveServiceSpeech.json", "market/img/NODERED.png", "png",
			...
			createMarketAsset("MASTER-MarketAsset-19", "NoderedACSTranslation", MarketAsset.MarketAssetState.APPROVED,
					MarketAsset.MarketAssetType.DOCUMENT, MarketAsset.MarketAssetPaymentMode.FREE, true,
					"market/details/NoderedAzureCognitiveServiceTranslation.json", "market/img/NODERED.png", "png",
			...
			createMarketAsset("MASTER-MarketAsset-20", "NoderedACSVision", MarketAsset.MarketAssetState.APPROVED,
					MarketAsset.MarketAssetType.DOCUMENT, MarketAsset.MarketAssetPaymentMode.FREE, true,
					"market/details/NoderedAzureCognitiveServiceVision.json", "market/img/NODERED.png", "png",
			...
			createMarketAsset("MASTER-MarketAsset-21", "OpenNotify", MarketAsset.MarketAssetState.APPROVED,
					MarketAsset.MarketAssetType.DOCUMENT, MarketAsset.MarketAssetPaymentMode.FREE, true,
					"market/details/OpenNotify.json", "market/img/NODERED.png", "png",
					"market/docs/OpenNotify.json", "AzureCognitiveServiceVision.json");
			...
			// Stress Application
			// createMarketAsset("MASTER-MarketAsset-10", "StressApplication",
			// MarketAsset.MarketAssetState.APPROVED,
			// MarketAsset.MarketAssetType.URLAPPLICATION,
			// MarketAsset.MarketAssetPaymentMode.FREE, true,
			// "market/details/StressApplication.json", null, null, null, null);

			//
			// createMarketAsset("MASTER-MarketAsset-16", "management",
			// MarketAsset.MarketAssetState.APPROVED,
			// MarketAsset.MarketAssetType.WEBPROJECT,
			// MarketAsset.MarketAssetPaymentMode.FREE, true,
	...
	public void init_dataflow_user_access_type() {
		log.info("init dataflow access type");
		final List<PipelineUserAccessType> pipeline_uat = pipelineUserAccessTypeRepository.findAll();
		if (pipeline_uat.isEmpty()) {
			try {
	...
	public void init_GadgetTemplate() {
	...
	private void init_OntologyRestaurants() {
		...
		if (ontologyRepository.findByIdentification("Restaurants") == null) {
			...
			ontology.setMetainf("Restaurants");
			ontology.setActive(true);
