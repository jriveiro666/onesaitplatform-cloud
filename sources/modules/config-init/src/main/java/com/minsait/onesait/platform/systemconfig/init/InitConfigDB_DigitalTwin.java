...
@Slf4j
@Component
public class InitConfigDB_DigitalTwin {
	...
	public void init_DigitalTwinDevice() {
	...
	public void init_DigitalTwinType() {
	...
	private Set<EventsDigitalTwinType> createTurbineEventsDT(DigitalTwinType type) {
		final Set<EventsDigitalTwinType> events = new HashSet<EventsDigitalTwinType>();
	...
	private Set<ActionsDigitalTwinType> createTurbineActionsDT(DigitalTwinType type) {
		final Set<ActionsDigitalTwinType> actions = new HashSet<ActionsDigitalTwinType>();
	...
	private Set<PropertyDigitalTwinType> createTurbinePropertiesDT(DigitalTwinType type) {
		final Set<PropertyDigitalTwinType> props = new HashSet<PropertyDigitalTwinType>();
