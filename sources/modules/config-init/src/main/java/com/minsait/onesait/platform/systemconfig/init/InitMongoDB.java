...
public class InitMongoDB {
	...
	private final String CAS_TICKET_REGISTRY = "cas_ticket_registry";
	private final String CAS_SERVICE_REGISTRY = "cas_service_registry";
	private final String SUPERMARKETS_STR = "Supermarkets";
	...
	private User getUserAdministrator() {
		final User userCollaborator = userCDBRepository.findByUserId("administrator");
		return userCollaborator;
	}
