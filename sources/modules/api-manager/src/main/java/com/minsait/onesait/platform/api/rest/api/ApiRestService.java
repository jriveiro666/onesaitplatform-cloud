...
public interface ApiRestService {
	...
	public Response getApi(
			...
			@HeaderParam("X-OP-APIKey") String token) throws Exception;
	...
	@ApiResponses(value = { @ApiResponse(code = 204, message = "No Content"),
			@ApiResponse(code = 400, message = "Bad Request"), @ApiResponse(code = 401, message = "Unauthorized"),
			@ApiResponse(code = 501, message = "Internal Server Error") })
	public Response create(ApiDTO api, @HeaderParam("X-OP-APIKey") String token) throws Exception;
	...
	@ApiResponses(value = { @ApiResponse(code = 204, message = "No Content"),
			@ApiResponse(code = 400, message = "Bad Request"), @ApiResponse(code = 401, message = "Unauthorized"),
			@ApiResponse(code = 501, message = "Internal Server Error") })
	public Response update(ApiDTO suscripcion, @HeaderParam("X-OP-APIKey") String token) throws Exception;
	...
	@ApiResponses(value = { @ApiResponse(code = 204, message = "No Content"),
			@ApiResponse(code = 400, message = "Bad Request"), @ApiResponse(code = 401, message = "Unauthorized"),
			@ApiResponse(code = 501, message = "Internal Server Error") })
	public Response delete(ApiDTO suscripcion, @HeaderParam("X-OP-APIKey") String token) throws Exception;
