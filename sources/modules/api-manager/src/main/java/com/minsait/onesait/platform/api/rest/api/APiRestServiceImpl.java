...
public class APiRestServiceImpl implements ApiRestService {
	...
	public Response getApiFilter(String identificacion, String estado, String usuario, String tokenUsuario)
		...
		if (user == null)
			return Response.status(Status.UNAUTHORIZED).build();
		final List<Api> apis = apiService.findApis(identificacion, estado, usuario, tokenUsuario);
	...
	public Response create(ApiDTO api, String tokenUsuario) throws Exception {
		...
		final Object parametros[] = { api.getIdentification() };
	...
	public Response delete(ApiDTO api, String tokenUsuario) throws Exception {
		...
		final Object parametros[] = { api.getIdentification(), api.getVersion().toString() };
		return Response.ok(parametros).build();
	}
	...
	public Response deleteByIdentificacionNumversion(String identificacion, String numversion, String tokenUsuario)
		...
		final Object parametros[] = { identificacion, numversion };
		return Response.ok(parametros).build();
	}
	...
	public Response create(String indentifier, ApiStates api, String token) throws Exception {
		...
		if (apiRes != null) {
			final Object parametros[] = { apiRes };
			return Response.ok(parametros).build();
		} else
