...
import com.minsait.onesait.platform.ApiManagerApplication;
import com.minsait.onesait.platform.api.init.LoadHelsinkiSampleData;
...
public class ApiManagerInvokationTest {
	...
	@Test
	public void testApiSofia2TokenCallWithXSofia2ApiKey() throws Exception {
	...
	public void testApiSofia2TokenCall() throws Exception {
		...
		HttpHeaders headers = new HttpHeaders();
		headers.add("X-OP-APIKey", "acbca01b-da32-469e-945d-05bb6cd1552e");
		headers.add(HttpHeaders.ACCEPT, MediaType.APPLICATION_JSON_VALUE);
		headers.add(HttpHeaders.ACCEPT_CHARSET, StandardCharsets.UTF_8.name());
