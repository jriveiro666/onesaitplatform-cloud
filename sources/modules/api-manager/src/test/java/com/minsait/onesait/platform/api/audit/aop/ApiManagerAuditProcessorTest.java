...
public class ApiManagerAuditProcessorTest {
	...
	public void given_getStoppedEvent_no_stop_status() {
		...
		data.put(ApiServiceInterface.STATUS, ChainProcessingStatus.FOLLOW);
	...
	public void given_getStoppedEvent_stop_status() {
		...
		data.put(ApiServiceInterface.REASON, REASON);

		data.put(ApiServiceInterface.REMOTE_ADDRESS, REMOTE_ADDRESS);
		data.put(ApiServiceInterface.ONTOLOGY, null);
		data.put(ApiServiceInterface.METHOD, ApiOperation.Type.GET.name());

		data.put(ApiServiceInterface.QUERY, "query test");
		data.put(ApiServiceInterface.BODY, "body test");
		data.put(ApiServiceInterface.API, getApiTest());
		data.put(ApiServiceInterface.USER, null);
