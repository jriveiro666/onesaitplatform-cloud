...
import com.minsait.onesait.platform.security.Oauth2AuthenticationProvider;
import com.minsait.onesait.platform.security.ri.ConfigDBAuthenticationProvider;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and().authorizeRequests()
				...
				.and().authenticationProvider(authenticationProviderOnesaitPlatform());
