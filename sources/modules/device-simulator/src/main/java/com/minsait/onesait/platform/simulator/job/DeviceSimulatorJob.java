...
public class DeviceSimulatorJob {
	...
	private final static String PATH_INSTANCES = "instances";
	private final static String PATH_INSTANCES_MODE = "instancesMode";
	private final static String MODE_RANDOM = "random";
	private final static String MODE_SEC = "sequential";
	private final static String INDEX_STR = "index";
	...
	public void proxyJson(String user, String json, JobExecutionContext context) throws Exception {
	...
	public void insertInstacesFromJson(String user, String json, JobExecutionContext context) throws Exception {
	...
	public JsonNode generateInstanceAndInsert(String user, String json) throws Exception {
