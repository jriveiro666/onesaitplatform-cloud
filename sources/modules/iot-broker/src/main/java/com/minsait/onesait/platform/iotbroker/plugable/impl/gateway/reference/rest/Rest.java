...
public class Rest extends WebMvcConfigurerAdapter {
	...
	public ResponseEntity<?> deleteByQuery(
			...
			@ApiParam(value = "Response Will include modidified Ids", required = false) @RequestParam(name = "ids", required = false, defaultValue = "false") String ids) throws UnsupportedEncodingException {
