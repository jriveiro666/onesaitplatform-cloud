...
public class QueryProcessor implements MessageTypeProcessor {
	...
	private static final String DEFAULT_JSON_SUCCESS_RESPONSE = "{\"result\":\"ok\"}";
	private static final String UPDATE_RESULT_MATCHER = "updated \\{\"count\":(\\d+)\\} rows";
	private static final String DELETE_RESULT_MATCHER = "deleted \\{\"count\":([0-9]+)\\} rows";
