...
public class JenkinsTest {
	...
	private final static String JENKINS_URL = "https://sofia2-devops.westeurope.cloudapp.azure.com/jenkins";
	private final static String JOB_NAME = "ALL-modules-onesaitplatform-imagegen";
	private final static String USERNAME = "fjgcornejo";
	private final static String TOKEN = "117dd1908f760ecdb160e63779bba677aa";
	private final static String NEW_JOB_NAME = "microserviceTest";
	private final static String NEW_JOB_FOLDER_NAME = "microservices";
	private final static String FOLDER_CONFIG_XML = "<?xml version=\"1.1\" encoding=\"UTF-8\"?>\n"
	...
	@Test
	public void testJenkinsConn() {
		final JobInfo job = jenkinsService.getJobInfo(JENKINS_URL, USERNAME, TOKEN, JOB_NAME, null);
		assertTrue(job.displayName().equalsIgnoreCase(JOB_NAME));
	}

	@Test
	public void createJobWithinFolder() {
		// jenkinsService.createJobFolder(JENKINS_URL, USERNAME, TOKEN, null,
		// FOLDER_CONFIG_XML);
	...
	public void buildWithParameters() {
		...
		params.put("DOCKER_MODULETAGVALUE", Arrays.asList("latest"));
		params.put("GIT_URL", Arrays.asList(
				"https://fjgcornejo:xmZy_Pdy118HXzy7wrvh@onesait-git.cwbyminsait.com/fjgcornejo/microservices-test.git"));
