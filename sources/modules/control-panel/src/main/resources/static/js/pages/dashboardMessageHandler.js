		 ...
		 $.ajax({
           ...
           'success': function(data) {
               ...
               if(data.status!=null && data.status === "OK"){
            	    ...
            	    angular.element(document.querySelector("dashboard")).controller("dashboard").api.createGadget(data.type,data.id,command.information.gadgetName,data.gadgetTemplate,data.gadgetDatasource,data.filters,data.setupLayout);          	
		 ...
		 $.ajax({
          ...
          'success': function(data) {
       	   ...
       	   if(data.status!=null && data.status === "Template"){
       		    angular.element(document.querySelector("dashboard")).controller("dashboard").api.updateFilterGadget(command.information.gadgetId,data.filters,data.merge);
       		    data.status = "OK";
       		    sendMessageParent(data);
