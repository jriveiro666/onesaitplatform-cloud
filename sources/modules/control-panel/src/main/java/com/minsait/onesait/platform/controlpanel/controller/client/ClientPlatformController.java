...
public class ClientPlatformController {
	...
	public ResponseEntity<?> getAccess(@RequestParam("ontology") String ontology) {
		...
		if (utils.getRole().equals("ROLE_ADMINISTRATOR") || userStr.equals(ontologySelected.getUser().getUserId())) {
			...
			return new ResponseEntity<>(clientPlatformService.getClientPlatformOntologyAccessLevel(), HttpStatus.OK);
			...
			return new ResponseEntity<Object>(accessList, HttpStatus.OK);
		}
