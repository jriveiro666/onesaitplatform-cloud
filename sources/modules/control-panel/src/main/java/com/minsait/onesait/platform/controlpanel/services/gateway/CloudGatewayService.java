...
public interface CloudGatewayService {

	void publishMicroserviceToGateway(Microservice microservice) throws MicroserviceException;

	void refreshRoutesCache();

	String getDeployedMicroserviceURL(Microservice microservice);
}
