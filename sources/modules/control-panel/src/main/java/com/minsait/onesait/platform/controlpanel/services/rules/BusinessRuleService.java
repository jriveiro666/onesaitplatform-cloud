...
public interface BusinessRuleService {
	...
	void save(DroolsRule rule, String userId) throws Exception;

	void update(DroolsRule rule, String userId, String identification) throws Exception;
	...
	void updateDRL(String identification, String newDRL) throws Exception;
