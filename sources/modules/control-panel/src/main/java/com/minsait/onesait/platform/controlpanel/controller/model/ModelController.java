...
public class ModelController {
	...
	@PreAuthorize("hasAnyRole('ROLE_ADMINISTRATOR','ROLE_DATASCIENTIST')")
	@Transactional
	public ResponseEntity<?> createModel(org.springframework.ui.Model model, @Valid ModelDTO modelDto,
	...
	@PreAuthorize("hasAnyRole('ROLE_ADMINISTRATOR','ROLE_DATASCIENTIST')")
	@Transactional
	public ResponseEntity<?> updateModel(org.springframework.ui.Model model, @PathVariable("id") String id,
