...
public class ThemesController {
	...
	public ResponseEntity<String> getThemeJson(){
		...
		if (activeThemes.size() == 1) {
			return new ResponseEntity<String>(activeThemes.get(0).getJson(), HttpStatus.OK);
		}
			...
			while (jsonKeys.hasNext()) {
				...
				switch (loginTitle){
					case LOGIN_TITLE:
						...
						break;
					case LOGIN_TITLE_ES:
						themeDTO.setLoginTitle_es(json.get(LOGIN_TITLE_ES).toString());
						break;	
					case LOGIN_IMAGE:
					...
					case FOOTER_TEXT:
						...
						break;
					case FOOTER_TEXT_ES:
						themeDTO.setFooterText_es(json.get(FOOTER_TEXT_ES).toString());
						break;
					default: break;
				}
