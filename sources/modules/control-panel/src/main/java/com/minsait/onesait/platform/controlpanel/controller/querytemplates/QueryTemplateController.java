...
public class QueryTemplateController {
	...
	public String list(Model uiModel, HttpServletRequest request) {
		...
		/*
		 * String identification = request.getParameter("identification"); String
		 * description = request.getParameter("description");
		 * 
		 * if (identification != null) { if (identification.equals("")) identification =
		 * null; } if (description != null) { if (description.equals("")) description =
		 * null; }
		 */
	...
	public String update(Model model, @PathVariable("id") String id) {
		...
		if (queryTemplate != null) {
			...
			qTemplate.setOntology(queryTemplate.getOntology().getIdentification());
	...
	private List<OntologyDTO> getOntologiesDTO() {
		List<OntologyDTO> listOntologies = new ArrayList<OntologyDTO>();
