...
public class ApiOperationDTO implements Cloneable, Serializable {
	...
	public ApiOperationDTO(ApiOperation apiOp) {
		...
		this.headers = new ArrayList<ApiHeaderDTO>();
		this.queryParams = new ArrayList<ApiQueryParameterDTO>();
