...
public class OntologyControllerTest {
	...
	public void given_OneOntologyWithUserAccess_When_CorrectParametersAreSentToUpdate_Then_TheOntologyUserAccessIsUpdatedAndTheNewValuesAreReturnedAsJSON()
			throws Exception {
		OntologyUserAccess accessOld = ontologyUserAccessCreator("ontologyId", "userOntology", "user", "ALL",
				"accessId");
		OntologyUserAccess accessNew = ontologyUserAccessCreator("ontologyId", "userOntology", "user", "QUERY",
				"accessId");
	...
	private List<OntologyUserAccess> createAccesses() {
		...
		OntologyUserAccess access1 = ontologyUserAccessCreator("ontologyId", "userOntology", "user1", "ALL",
				"accessId1");
		OntologyUserAccess access2 = ontologyUserAccessCreator("ontologyId", "userOntology", "user2", "ALL",
				"accessId2");
