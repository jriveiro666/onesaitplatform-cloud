...
public class TestSimpleRule {
	...
	@Test
	public void loadMultipleRulesAndFire() {
	...
	@Test
	public void whenTryingToFireRulesFromAnotherUser_then0RulesAreFired() {
		final KieServicesManagerImpl loader = new KieServicesManagerImpl();
		final String admin = "admin";
		loader.initializeRuleEngineDomain(admin);
		loader.addRule(admin, RULE_ROLE, "rule_role_1");
	...
	@Test
	public void loadTheSameRuleInDifferentJARs() {
		final KieServicesManagerImpl loader = new KieServicesManagerImpl();
		final String admin = "admin";
		loader.initializeRuleEngineDomain(admin);
		loader.addRule(admin, RULE_ROLE, "rule_role_1");
	...
	@Test
	public void loadTwoRules_thenFire_thenDeleteOneRule_andOnlyOneGetsFired() {
		final KieServicesManagerImpl loader = new KieServicesManagerImpl();
		final String admin = "admin";
		loader.initializeRuleEngineDomain(admin);
		loader.addRule(admin, RULE_ROLE, "rule_role_1");
