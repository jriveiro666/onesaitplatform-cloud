...
public class HazelcastCacheConfig {
	...
	public ITopic<String> topicChangedRules() {
		...
		topicChangedRules.addMessageListener(msg -> {
			HazelcastRuleObject.fromJson(msg.getMessageObject()).ifPresent(hro -> rulesManagerService.manageRule(hro));
	...
	public ITopic<String> topicAsyncComm() {
		final ITopic<String> topicChangedDomains = hazelcastInstance.getTopic(topicAsyncComm);
		return topicChangedDomains;
	}
