...
public class RecordEL {
  ...
  public static Object getValue(
    ...
    if (record != null) {
      Field field = record.get(fieldPath);
      if (field != null) {
    	  value = field.getValue() instanceof String ? field.getValueAsString().replaceAll("((?<![\\\\])['\"])", "\\\\'") : field.getValue(); // Added escaping quotes
      }
    }
    return value;
  }
  ...
  public static Map<String, Field> getDelimitedAsMap() {
