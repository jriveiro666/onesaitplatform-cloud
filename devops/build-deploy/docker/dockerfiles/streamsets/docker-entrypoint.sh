...
cp -rf /tmp/streamsets-libs /opt/streamsets-datacollector-3.3.0
...
sed -i "/runner.thread.pool.size=50/c\runner.thread.pool.size=${OP_STREAMSETS_POOL_SIZE}" "${SDC_CONF}/sdc.properties"
