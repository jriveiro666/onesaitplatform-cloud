...
java $JAVA_OPTS -jar quasar-web-assembly-40.0.0.jar initUpdateMetaStore -c config.json

java $JAVA_OPTS -Dlog4j.configuration=file:/usr/local/onesait/quasar/log4j.properties -jar quasar-web-assembly-40.0.0.jar -c config.json -P plugins/